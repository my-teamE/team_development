        ...
        <div class="split-container">
            <div class="location-contr" id="" style="padding:20px 0px">
                ...
                <div id="location" class="text-center py-3">
                    ...
                    <div>
                        ...
                        <div class="container1 p-2 " style="background: rgb(38, 36, 36)">
                            ...
                            <div class="slider flex">
                                <div class="slick-img">
                                    <img src="{{ asset('/storage/images/project1.png') }}" alt="Image" />
                                </div>
                                <div class="slick-img">
                                    <a href=""><img src="{{ asset('/storage/images/project2.jpg') }}"
                                            alt="Image" /></a>
                                </div>
                                <div class="slick-img">
                                    <a href=""><img src="{{ asset('/storage/images/project3.jpg') }}"
                                            alt="Image" /></a>
                                </div>
                                <div class="slick-img">
                                    <a href=""><img src="{{ asset('/storage/images/student1.jpg') }}"
                                            alt="Image" /></a>
                                </div>
                                <div class="slick-img">
                                    <a href=""><img src="{{ asset('/storage/images/aaa.jpg') }}"
                                            alt="" /></a>
                                </div>
                                <div class="slick-img">
                                    <a href=""><img src="{{ asset('/storage/images/20210311134726.jpg') }}"
                                            alt="" /></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex">
                        <h4 class="title" style="font-size:30px;padding:2% 0;width:30%">By the community, for the community
                        </h4>
                        {{-- 検索 --}}
                            ...
                            <article
                                ...
                                <a href="{{ asset('/apply/' . $record->id) }}" class="photo-link ">
                                    <img class="photo-thumb photo-1 "
                                        ...
                                        width="640" height="360" alt="button-open" />
                                </a>
                                <div class="photo-meta ">
                                    <p class="title text-yellow-500 text-2xl ">{{ $record->title }} </p>
                                    <div class="flex">
                                        <div class="user font-bold mb-2" style="width:90%"><a
                                                href="">{{ $record->name }}</a>
                                        </div>
                                        <div>
                                            <i id="heartIcon" class="fas fa-heart text-end cursor-pointer"
                                                style="width: 20px;color:white"></i>
                                        </div>
                                    </div>
                                </div>
                                <p class="text-gray-400 text-xs text-end pr-4 pb-2"><time
                                        datetime="投稿記事の⽇時">2023/07/26</time></p>
                            </article>
                        @endforeach
                    </section>
    </main>
