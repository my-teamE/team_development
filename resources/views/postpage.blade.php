    ...
    <form action="/hoge" method="post" enctype="multipart/form-data">
        ...
        <div class="hover:bg-yellow px-5 mb-10 shadow-md">
            ...
            <div class="my-4 px-5 py-2 border-b text-black" style="width: 100%;">
                ...
                <input type="text" name="title" id="title" class="w-full text-2xl font-bold leading-10 border border-gray-300 rounded-md mx-auto bg-gray-500 pl-4 placeholder-gray-900" placeholder=" Title" style="border-radius: 8px;">
                @error('title')
                <p style="color: red">{{$message}}</p>
                @enderror
            </div>
            ...
            <div class="my-4 px-5 py-2 border-b text-black" style="width: 100%;">
                ...
                <textarea name="body" id="body" placeholder="本文" class="w-full h-80 leading-10 text-base px-3 py-2 border border-gray-300 rounded-md mx-auto bg-gray-500 pl-4 placeholder-gray-900 text-2xl" style="height: 200px; border-radius: 8px;" value="{{old('body')}}"></textarea>
                @error('body')
                <p style="color: red">{{$message}}</p>
                @enderror
            </div>
            ...
            <div class="text-center text-lg pb-2" style="width: 100%">
               <b style="color:black"><button type="button" class="my-2 mx-3 px-4 py-2 bg-gray-100 hover:bg-gray-900 hover:text-white rounded">Cancer</button></b>
                <b> <button type="submit" class="my-2 mx-3 px-4 py-2 bg-gray-900 hover:bg-white hover:text-black rounded">Publish</button></b>
            </div>
        </div>
    </form>
</section>
